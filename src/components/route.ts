  ...
  try {
    ...
    try {
      ...
      if (rssRes.ok) {
        ...
        // Extraer títulos, fuentes y fechas usando expresiones regulares para evitar librerías pesadas
      ...
      console.warn("Fallo al obtener RSS local, la IA usará su motor de búsqueda nativo.", e);
    }
...
Analiza estrictamente si los eventos recientes en las noticias confirman o agravan los riesgos descritos en la hipótesis (ej. coincidencia con giros comerciales, marginación demográfica o historial delictivo).
