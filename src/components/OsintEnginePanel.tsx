...
const OsintEnginePanel: React.FC<Props> = ({
  project,
  setOsintResults,
}) => {
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-slate-800 rounded p-3">
              <p className="text-xs text-slate-400">SERPAPI</p>
              <p className="text-xl text-cyan-300 font-bold">{results.serp?.length || 0}</p>
            </div>

            <div className="bg-slate-800 rounded p-3">
              <p className="text-xs text-slate-400">NEWSAPI</p>
              <p className="text-xl text-fuchsia-300 font-bold">{results.news?.length || 0}</p>
            </div>

            <div className="bg-slate-800 rounded p-3">
              <p className="text-xs text-slate-400">GNEWS</p>
              <p className="text-xl text-emerald-300 font-bold">{results.gnews?.length || 0}</p>
            </div>

            <div className="bg-slate-800 rounded p-3">
              <p className="text-xs text-slate-400">NEWSDATA</p>
              <p className="text-xl text-orange-300 font-bold">{results.newsdata?.length || 0}</p>
            </div>

            <div className="bg-slate-800 rounded p-3">
              <p className="text-xs text-slate-400">THENEWSAPI</p>
              <p className="text-xl text-red-300 font-bold">{results.thenews?.length || 0}</p>
            </div>

            <div className="bg-slate-800 rounded p-3">
              <p className="text-xs text-slate-400">DENUE</p>
              <p className="text-xl text-yellow-300 font-bold">{results.denue?.length || 0}</p>
            </div>
...
export default OsintEnginePanel;
